...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=data/OpenVLThinker/train.parquet \
    ...
    trainer.experiment_name='OpenVLThinker_supervised_v1' \
...
echo 'merging model'
PROJECT_NAME='geo'
CHECKPOINT_DIR="checkpoints/geo/OpenVLThinker_supervised_v1"
...
if [ -n "$LATEST_STEP" ]; then
    ...
    mkdir ../models/OpenVLThinker_supervised_v1
    cp -rL ${CHECKPOINT_DIR}/${LATEST_STEP}/actor/huggingface/* ../models/OpenVLThinker_supervised_v1
